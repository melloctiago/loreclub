...
# Adiciona o caminho do app para que o Alembic encontre os modelos
import sys
...
from app.models.quest import Quest, quest_heroes_association
...
# target_metadata é usado para 'autogenerate'
